...
namespace TestTask.Controllers
{
    ...
    public class UsersController : ControllerBase
    {
        ...
        {
            var result = await this.userService.GetUserWithLargestNumberOfOrders(); // Method name changed
        ...
        {
            var result = await this.userService.GetInactiveUsers(); // Method name changed
            return this.Ok(result);
        }
    }
}
