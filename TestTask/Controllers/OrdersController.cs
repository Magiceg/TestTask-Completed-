...
namespace TestTask.Controllers
{
    ...
    public class OrdersController : ControllerBase
    {
        ...
        {
            var result = await this.orderService.GetOrderWithLargestOrderAmount(); // Method name changed
        ...
        {
            var result = await this.orderService.GetOrdersWithMoreThan10Items(); // Method name changed
            return this.Ok(result);
        }
    }
}
